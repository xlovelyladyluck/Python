...
class MyTestCase(unittest.TestCase):
   ...
   def test_score_input_test_score_valid(self):
    ...
    #def test_score_input_test_score_below_range(self):
     #   self.assertAlmostEqual(validate_input_in_functions.score_input("Math", -25), "Invalid test score, Try again.")

    #def test_score_input_test_score_above_range(self):
      #  self.assertAlmostEqual(validate_input_in_functions.score_input("English", 125),"Invalid test score, Try again.")

    #def test_test_score_non_numeric(self):
       # self.assertAlmostEqual(validate_input_in_functions.score_input("French", "!!!"), "invalid literal for int() with base 10: '!!!'")
